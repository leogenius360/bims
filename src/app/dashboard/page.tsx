...
const Dashboard = () => {
  ...
  } else if (user && allowedUsers.sales.includes(user.email!)) {
    return <h3>SALES PERSON DASHBOARD</h3>;
  } else if (user && allowedUsers.delivery.includes(user.email!)) {
    return <h3>DELIVERY PERSON DASHBOARD</h3>;
  } else return;
};
