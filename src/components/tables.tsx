...
const products = [
  {
    ...
    date: new Date().toDateString(),
    product: "Tony Reichert",
    category: "Tony Reichert",
    inventoryMethod: "Tony Reichert",
    latestUpdateBy: "Leogenius",
...
export const ProductsTable = () => {
  const TopContent = <h3 className="font-bold">Products Table</h3>;
  const BottomContent = <h3 className="font-bold">Current stock</h3>;
  ...
  return (
    ...
    >
      <TableHeader columns={productFields}>
        {(column) => <TableColumn key={column.key}>{column.label}</TableColumn>}
      </TableHeader>
      <TableBody
        items={products}
